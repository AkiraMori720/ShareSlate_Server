...
import {sendBroadcastNotificationToMySQL} from "/app/lib/server/lib/sendNotificationsOnMessage";
...
export const createDirectRoom = function(members, roomExtraData = {}, options = {}) {
	...
	if (isNewRoom) {
		...
		members.forEach((member) => {
			sendBroadcastNotificationToMySQL(insertedRoom, member, 'create_channel');
		});
